...
from .cascade_mask_rcnn_mvitv2_b_in21k_100ep_smoke import model
...
train.output_dir = 'smoke_cas_swin_b_in21k_model_50ep'

# Schedule
dataloader.train.total_batch_size = 8

# 100 ep = 184375 iters * 64 images/iter / 118000 images/ep
# train.max_iter = 80950    # 3238 ~= total_batch_size*max_iter/total_epochs
train.max_iter = 40475    # 3238 ~= total_batch_size*max_iter/total_epochs

lr_multiplier = L(WarmupParamScheduler)(
    scheduler=L(MultiStepParamScheduler)(
        values=[1.0, 0.1, 0.01],
#         milestones=[163889, 177546],
#         milestones=[64800, 77800],
        milestones=[32400, 38900],
