...
from .mask_rcnn_vitdet_b_100ep_playphone import (
    dataloader,
    lr_multiplier,
    model,
    train,
...
train.output_dir = 'playphone_cas_vitdet_b_model_100ep'

dataloader.train.total_batch_size = 4

# Schedule
# 100 ep = 184375 iters * 64 images/iter / 118000 images/ep
train.max_iter = 64000    # 2460 ~= total_batch_size*max_iter/total_epochs
