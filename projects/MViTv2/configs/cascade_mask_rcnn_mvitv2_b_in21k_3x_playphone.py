from .cascade_mask_rcnn_mvitv2_b_3x_playphone import model, dataloader, optimizer, lr_multiplier, train
...
train.output_dir = 'playphone_cas_mvitv2_b_in21k_model_50ep'