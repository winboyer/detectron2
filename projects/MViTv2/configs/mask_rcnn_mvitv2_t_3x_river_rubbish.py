...
train.output_dir = 'river_rubbish_model'
...
# train.max_iter = 2700    # 600 ~= total_batch_size*max_iter/total_epochs
# 50 epochs
train.max_iter = 3750    # 600 ~= total_batch_size*max_iter/total_epochs
lr_multiplier = L(WarmupParamScheduler)(
    scheduler=L(MultiStepParamScheduler)(
        values=[1.0, 0.1, 0.01],
#         milestones=[52500, 62500, 67500],
#         milestones=[2000, 2500, 2700],
        milestones=[2000, 3200, 3700],
    ),
