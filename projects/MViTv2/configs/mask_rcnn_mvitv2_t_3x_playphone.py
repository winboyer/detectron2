...
train.output_dir = 'playphone_mvitv2_t_model_50ep'

# dataloader.train.total_batch_size = 64
dataloader.train.total_batch_size = 8

# 36 epochs
# train.max_iter = 11250    # 2460 ~= total_batch_size*max_iter/total_epochs
# 50 epochs
train.max_iter = 16000    # 2460 ~= total_batch_size*max_iter/total_epochs

lr_multiplier = L(WarmupParamScheduler)(
    scheduler=L(MultiStepParamScheduler)(
        values=[1.0, 0.1, 0.01],
#         milestones=[8000, 10000, 11250],
