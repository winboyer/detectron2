...
from .mask_rcnn_mvitv2_t_3x_river_rubbish import model, dataloader, optimizer, lr_multiplier, train
...
train.init_checkpoint = "/root/jinyfeng/models/vitdet-models/model_final_cascade_mask_rcnn_mvitv2_t_3x.pkl"
train.output_dir = 'river_rubbish_cas_mvitv2_t_model_50ep'
